...
export default class Bubble extends React.Component {
  ...
  handleBubbleToNext() {
    if (
      ...
      isMessageInInterval(this.props.currentMessage, this.props.nextMessage)
    ) {
  ...
  handleBubbleToPrevious() {
    if (
      ...
      isMessageInInterval(this.props.currentMessage, this.props.previousMessage)
    ) {
      return StyleSheet.flatten([
    ...
    return (
      ...
      >
        ...
        <View style={[styles[this.props.position].wrapper]}>
          <View
            style={[
              styles[this.props.position].background,
...
const styles = {
  ...
  right: StyleSheet.create({
    ...
    background: {
      borderRadius: 8,
      borderWidth: 0.1,
      borderColor: Colors.background.munsell,
      backgroundColor: Colors.background.munsell
    },
    container: {
      flex: 1,
      alignItems: "flex-end"
